...
class ModelConfig:
    ...
    train_annotation: str = "/mnt/media/fair/audio/replay_attacks/datasets/Mixed_Datasets/ASVSpoof2017_ASVSpoof2019_ReMASC_LRPD_MAILABS_MLAAD_originalandtelephone/Wav2Vec2_annotations/train_augmented_random_annotations_balanced.json"
    valid_annotation: str = "/mnt/media/fair/audio/replay_attacks/datasets/Mixed_Datasets/ASVSpoof2017_ASVSpoof2019_ReMASC_LRPD_MAILABS_MLAAD_originalandtelephone/Wav2Vec2_annotations/dev_augmented_random_annotations_balanced.json"
