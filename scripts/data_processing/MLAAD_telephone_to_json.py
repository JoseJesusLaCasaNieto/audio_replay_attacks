...
if __name__ == "__main__":
    ...
    root_dir = '/mnt/media/fair/audio/replay_attacks/datasets/MLAAD_telephone/fake'
    train_json_path = '/mnt/media/fair/audio/replay_attacks/datasets/MLAAD_telephone/Wav2Vec2_annotations/train_annotations.json'
    dev_json_path = '/mnt/media/fair/audio/replay_attacks/datasets/MLAAD_telephone/Wav2Vec2_annotations/dev_annotations.json'
