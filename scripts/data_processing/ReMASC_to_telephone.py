"""
ReMASC_to_telephone.py

This script processes the ReMASC audio dataset and generates a telephone-band version
...
source_root = Path('/mnt/media/fair/audio/replay_attacks/datasets/ReMASC')
destination_root = Path('/mnt/media/fair/audio/replay_attacks/datasets/ReMASC_telephone')
