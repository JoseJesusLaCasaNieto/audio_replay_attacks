...
source_root = Path('/mnt/media/fair/audio/replay_attacks/datasets/MLAAD')
destination_root = Path('/mnt/media/fair/audio/replay_attacks/datasets/MLAAD_telephone')
...
def main():
    ...
    for subdir in SUBDIRS:
        ...
        logger.success(f"Directory processed succesfully: {src_dir}")
