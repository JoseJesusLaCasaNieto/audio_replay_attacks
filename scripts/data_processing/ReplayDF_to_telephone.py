...
Usage:
    python replaydf_to_telephone.py
...
source_root = Path('/mnt/media/fair/audio/replay_attacks/datasets/ReplayDF')
destination_root = Path('/mnt/media/fair/audio/replay_attacks/datasets/ReplayDF_telephone')
