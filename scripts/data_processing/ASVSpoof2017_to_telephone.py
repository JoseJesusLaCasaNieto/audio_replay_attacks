"""
asvspoof2017_to_telephone.py

This script processes the ASVSpoof2017 audio dataset and generates a telephone-band version
...
3. Collect all .wav files in each subdirectory.
...
Usage:
    python asvspoof2017_to_telephone.py
...
source_root = Path('/mnt/media/fair/audio/replay_attacks/datasets/ASVSpoof2017')
destination_root = Path('/mnt/media/fair/audio/replay_attacks/datasets/ASVSpoof2017_telephone')
...
SUBDIRS = [
    ...
    'ASVspoof2017_V2_eval/ASVspoof2017_V2_eval'
]
