...
if __name__ == "__main__":
    ...
    root_dir = '/mnt/media/fair/audio/replay_attacks/datasets/ReplayDF_telephone/wav'
    output_json_path = '/mnt/media/fair/audio/replay_attacks/datasets/ReplayDF_telephone/Wav2Vec2_annotations/eval_annotations.json'
